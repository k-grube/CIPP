import{C as p}from"./CippImageCard-CLjpa1bz.js";import"./iframe-DTaiHxvg.js";import"./preload-helper-PPVm8Dsz.js";import"./link-axkzj7Lj.js";import"./createSimplePaletteValueFilter-NEMDFZiU.js";import"./CircularProgress-Byl06xYe.js";import"./Typography-BIJo1y5z.js";const{within:i,expect:n,fn:c}=__STORYBOOK_MODULE_TEST__,x={title:"Components/CippCards/CippImageCard",component:p,tags:["autodocs"],argTypes:{isFetching:{control:"boolean"},onButtonClick:c(),onClick:c()}},a={args:{title:"Reports Illustration",text:"This is a card showing reports and analytics.",imageUrl:"/CIPP/assets/illustrations/undraw_lost_re_xqjt.svg",linkText:"View Reports",link:"/reports"},play:async({canvasElement:e})=>{const t=i(e);await n(t.getByText("Reports Illustration")).toBeInTheDocument(),await n(t.getByText("This is a card showing reports and analytics.")).toBeInTheDocument();const l=t.getByRole("link",{name:/View Reports/i});await n(l).toHaveAttribute("href","/reports")}},s={args:{title:"Onboarding Step",text:"Please complete your company profile.",imageUrl:"/CIPP/assets/illustrations/undraw_website_ij0l.svg",step:2,maxstep:5,linkText:"Continue",link:"/onboarding"},play:async({canvasElement:e})=>{const t=i(e);await n(t.getByText("2/5")).toBeInTheDocument(),await n(t.getByRole("progressbar")).toBeInTheDocument()}},o={args:{title:"Loading Reports",isFetching:!0,imageUrl:"/CIPP/assets/illustrations/undraw_website_ij0l.svg"},play:async({canvasElement:e})=>{i(e);const t=e.querySelector(".MuiSkeleton-root");await n(t).toBeInTheDocument()}},r={args:{title:"Action Card",text:"This card triggers a custom action.",imageUrl:"/CIPP/assets/illustrations/undraw_website_ij0l.svg",linkText:"Click Me",onButtonClick:()=>alert("Button clicked!")}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  args: {
